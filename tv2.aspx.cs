...
public partial class tv2 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter sda;
    ...
    protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (CheckBoxList1.SelectedItem == null)
        {
            ...
            sda.Fill(ds, "t");
            li1.ImageUrl = "" + ds.Tables["t"].Rows[0][12].ToString();
            li2.ImageUrl = "" + ds.Tables["t"].Rows[1][12].ToString();
            li3.ImageUrl = "" + ds.Tables["t"].Rows[2][12].ToString();
            li4.ImageUrl = "" + ds.Tables["t"].Rows[3][12].ToString();
            li5.ImageUrl = "" + ds.Tables["t"].Rows[4][12].ToString();
            li6.ImageUrl = "" + ds.Tables["t"].Rows[5][12].ToString();
            li7.ImageUrl = "" + ds.Tables["t"].Rows[6][12].ToString();
            li8.ImageUrl = "" + ds.Tables["t"].Rows[7][12].ToString();
            li9.ImageUrl = "" + ds.Tables["t"].Rows[8][12].ToString();
            li10.ImageUrl = "" + ds.Tables["t"].Rows[9][12].ToString();
            li11.ImageUrl = "" + ds.Tables["t"].Rows[10][12].ToString();
            li12.ImageUrl = "" + ds.Tables["t"].Rows[11][12].ToString();
            li13.ImageUrl = "" + ds.Tables["t"].Rows[12][12].ToString();
            li14.ImageUrl = "" + ds.Tables["t"].Rows[13][12].ToString();
            li15.ImageUrl = "" + ds.Tables["t"].Rows[14][12].ToString();
            li16.ImageUrl = "" + ds.Tables["t"].Rows[15][12].ToString();
            ll1.Text = "" + ds.Tables["t"].Rows[0][1].ToString();
            ll3.Text = "" + ds.Tables["t"].Rows[1][1].ToString();
            ll2.Text = "" + ds.Tables["t"].Rows[2][1].ToString();
        ...
        foreach (ListItem li in CheckBoxList1.Items)
        {
            ...
            {
                q = li.Text;
                string s = "select * from tv where brand='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
                a = ds.Tables["t"].Rows.Count;
                // Label1.Text = "" + a;
                con.Close();
            }
            if (a == 4)
    ...
    public void work()
    {
        ...
        Label1.Text = ds.Tables["t"].Rows[0][1].ToString();
        Label2.Text = ds.Tables["t"].Rows[0][2].ToString();
        Label3.Text = ds.Tables["t"].Rows[0][3].ToString();
        Label4.Text = ds.Tables["t"].Rows[0][4].ToString();
        Label5.Text = ds.Tables["t"].Rows[0][5].ToString();
        Label6.Text = ds.Tables["t"].Rows[0][6].ToString();
        Label7.Text = ds.Tables["t"].Rows[0][7].ToString();
        Label8.Text = ds.Tables["t"].Rows[0][8].ToString();
        Label9.Text = ds.Tables["t"].Rows[0][9].ToString();
        Label10.Text = ds.Tables["t"].Rows[0][10].ToString();
        Label11.Text = ds.Tables["t"].Rows[0][11].ToString();
        Image2.ImageUrl = "" + ds.Tables["t"].Rows[0][12].ToString();
        ImageButton1.ImageUrl = "" + ds.Tables["t"].Rows[0][12].ToString();
        ImageButton3.ImageUrl = "" + ds.Tables["t"].Rows[0][13].ToString();
        ImageButton4.ImageUrl = "" + ds.Tables["t"].Rows[0][14].ToString();
        ImageButton5.ImageUrl = "" + ds.Tables["t"].Rows[0][15].ToString();

        if (ImageButton1.ImageUrl == "")
        {
    ...
    protected void ll1_Click(object sender, EventArgs e)
    {
        ...
        con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
        con.Open();
        string l = "select * from tv where Name='" + a + "'";
        sda = new SqlDataAdapter(l, con);
        sda.Fill(ds, "t");
        work();
        ll1.CommandName = "SwitchViewByID";
        ll1.CommandArgument = "details";
    ...
    protected void CheckBoxList3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (CheckBoxList3.SelectedItem == null)
        {
            ...
            li13.ImageUrl = "" + ds.Tables["t"].Rows[12][12].ToString();
            li14.ImageUrl = "" + ds.Tables["t"].Rows[13][12].ToString();
            li16.ImageUrl = "" + ds.Tables["t"].Rows[14][12].ToString();
            li15.ImageUrl = "" + ds.Tables["t"].Rows[15][12].ToString();
            ll1.Text = "" + ds.Tables["t"].Rows[0][1].ToString();
            ll3.Text = "" + ds.Tables["t"].Rows[1][1].ToString();
            ll2.Text = "" + ds.Tables["t"].Rows[2][1].ToString();
            ll4.Text = "" + ds.Tables["t"].Rows[3][1].ToString();
        ...
        foreach (ListItem li in CheckBoxList3.Items)
        {
            ...
            {
                q = li.Text;
                string s = "select * from tv where screen_type='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
            ...
            if (c == 5)
            {
                ...
                ll2.Text = "" + ds.Tables["t"].Rows[2][1].ToString();
                ll4.Text = "" + ds.Tables["t"].Rows[3][1].ToString();
                li5.ImageUrl = "" + ds.Tables["t"].Rows[3][12].ToString();
    ...
    protected void CheckBoxList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList2.Items)
        {
            ...
            {
                q = li.Value;
                string s = "select * from tv where hell='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    protected void CheckBoxList4_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList4.Items)
        {
            ...
            {
                q = li.Value;
                string s = "select * from tv where hell1='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    static int i112 = 0;
    protected void Timer21_Tick(object sender, EventArgs e)
    {
        string[] s = { "~/img1/1.jpg", "~/img1/2.jpg", "~/img1/3.jpg", "~/img1/4.jpg" };
        if (i112 < s.Length)
        {
            Image41.ImageUrl = s[i112];
            i112++;
        }
        else
        {
