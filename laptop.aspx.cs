...
public partial class laptop : System.Web.UI.Page
{
    ...
    static int i11 = 0;
    protected void Timer5_Tick1(object sender, EventArgs e)
    {
    ...
    protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList1.Items)
        {
            ...
            {
                q = li.Text;
                string s = "select * from laptop where Brand='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    protected void ll1_Click(object sender, EventArgs e)
    {
        ...
        con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
        con.Open();
        string l = "select * from laptop where Name='" + a + "'";
    ...
    protected void CheckBoxList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem lprice in CheckBoxList2.Items)
        {
            ...
            {
                q = lprice.Value;
                string s = "select * from laptop where Price between '" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    protected void CheckBoxList3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem lproc in CheckBoxList3.Items)
        {


            if (lproc.Selected == true)
            {
                r = lproc.Text;
                string s = "select * from laptop where Processor= '" + r + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
                b = ds.Tables["t"].Rows.Count;
                // Label1.Text = "" + a;
                con.Close();
            }
            if (b == 1)
    ...
    protected void CheckBoxList4_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem lhdd in CheckBoxList4.Items)
        {


            if (lhdd.Selected == true)
            {
                s1 = lhdd.Text;
                if (s1 == "1TB HDD")
                {
                    string s = "select * from laptop where hell='" + 1 + "'";
                    con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                    con.Open();
                    sda = new SqlDataAdapter(s, con);
                    sda.Fill(ds, "t");
                    d = ds.Tables["t"].Rows.Count;
                    // Label1.Text = "" + a;
                    con.Close();
                }
                else
                {
                    string s = "select * from laptop where HDD= '" + s1 + "'";
                    con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                    con.Open();
                    sda = new SqlDataAdapter(s, con);
                    sda.Fill(ds, "t");
    ...
    protected void CheckBoxList5_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem lram in CheckBoxList5.Items)
        {


            if (lram.Selected == true)
            {
                s2 = lram.Text;
                if (s2 == "16GB DDR3")
                {
                    string s = "select * from laptop where Price='" + 99999 + "'";
                    con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                    con.Open();
                    sda = new SqlDataAdapter(s, con);
                    sda.Fill(ds, "t");
                    f = ds.Tables["t"].Rows.Count;
                    // Label1.Text = "" + a;
                    con.Close();
                }
                else
                {
                    string s = "select * from laptop where RAM='" + s2 + "'";
                    con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                    con.Open();
                    sda = new SqlDataAdapter(s, con);
                    sda.Fill(ds, "t");
    ...
    protected void CheckBoxList6_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        int g = 0;
        if (CheckBoxList6.SelectedItem == null)
        {
        ...
        foreach (ListItem lgra in CheckBoxList6.Items)
        {


            if (lgra.Selected == true)
            {
                s3 = lgra.Text;
                
                
                    string s = "select * from laptop where Graphics='" + s3 + "'";
                    con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                    con.Open();
                    sda = new SqlDataAdapter(s, con);
                    sda.Fill(ds, "t");
                    g = ds.Tables["t"].Rows.Count;
                    // Label1.Text = "" + a;
                    con.Close();
              }
            if (g== 1)
