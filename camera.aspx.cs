...
public partial class laptop : System.Web.UI.Page
{
    ...
    protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (CheckBoxList1.SelectedItem == null)
        {
            ...
            sda.Fill(ds, "t");
            li1.ImageUrl = "" + ds.Tables["t"].Rows[0][6].ToString();
            li2.ImageUrl = "" + ds.Tables["t"].Rows[1][6].ToString();
            li3.ImageUrl = "" + ds.Tables["t"].Rows[2][6].ToString();
            li4.ImageUrl = "" + ds.Tables["t"].Rows[3][6].ToString();
            li5.ImageUrl = "" + ds.Tables["t"].Rows[4][6].ToString();
            li6.ImageUrl = "" + ds.Tables["t"].Rows[5][6].ToString();
            li7.ImageUrl = "" + ds.Tables["t"].Rows[6][6].ToString();
            li6.ImageUrl = "" + ds.Tables["t"].Rows[7][6].ToString();
            li9.ImageUrl = "" + ds.Tables["t"].Rows[8][6].ToString();
            li10.ImageUrl = "" + ds.Tables["t"].Rows[9][6].ToString();
            li11.ImageUrl = "" + ds.Tables["t"].Rows[10][6].ToString();
            li12.ImageUrl = "" + ds.Tables["t"].Rows[11][6].ToString();
            li13.ImageUrl = "" + ds.Tables["t"].Rows[12][6].ToString();
            li14.ImageUrl = "" + ds.Tables["t"].Rows[13][6].ToString();
            li16.ImageUrl = "" + ds.Tables["t"].Rows[14][6].ToString();
            li15.ImageUrl = "" + ds.Tables["t"].Rows[15][6].ToString();
        ...
        {int a=0;
            ...
            {
                q = li.Text;
                string s = "select * from Camera where Brand='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
            ...
            if (a == 8)
            {
                ...
                li6.ImageUrl = "" + ds.Tables["t"].Rows[5][6].ToString();
                li7.ImageUrl = "" + ds.Tables["t"].Rows[6][6].ToString();
                li6.ImageUrl = "" + ds.Tables["t"].Rows[7][8].ToString();
                ll1.Text = "" + ds.Tables["t"].Rows[0][1].ToString();
                ll3.Text = "" + ds.Tables["t"].Rows[1][1].ToString();
                ll2.Text = "" + ds.Tables["t"].Rows[2][1].ToString();
                ll4.Text = "" + ds.Tables["t"].Rows[3][1].ToString();
            ...
            if (a == 12)
            {
                ...
                li6.ImageUrl = "" + ds.Tables["t"].Rows[5][6].ToString();
                li7.ImageUrl = "" + ds.Tables["t"].Rows[6][6].ToString();
                li8.ImageUrl = "" + ds.Tables["t"].Rows[7][6].ToString();
                li9.ImageUrl = "" + ds.Tables["t"].Rows[8][6].ToString();
                li10.ImageUrl = "" + ds.Tables["t"].Rows[9][6].ToString();
                li11.ImageUrl = "" + ds.Tables["t"].Rows[10][6].ToString();
                li12.ImageUrl = "" + ds.Tables["t"].Rows[11][6].ToString();
    ...
    public void work()
    {
        ...
        ImageButton1.ImageUrl = "" + ds.Tables["t"].Rows[0][6].ToString();
        ImageButton3.ImageUrl = "" + ds.Tables["t"].Rows[0][7].ToString();
        ImageButton4.ImageUrl = "" + ds.Tables["t"].Rows[0][8].ToString();
        ImageButton5.ImageUrl = "" + ds.Tables["t"].Rows[0][9].ToString();
    ...
    protected void ll1_Click(object sender, EventArgs e)
    {
        ...
        con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
        con.Open();
        string l = "select * from Camera where Name='"+a+"'";
    ...
    protected void CheckBoxList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem lprice in CheckBoxList2.Items)
        {
            ...
            {
                q = lprice.Value;
                string s = "select * from Camera where hell='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    protected void CheckBoxList3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList3.Items)
        {
            ...
            {
                q = li.Text;
                string s = "select * from Camera where Quality='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    protected void CheckBoxList4_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList4.Items)
        {
            ...
            {
                q = li.Text;
                string s = "select * from Camera where Type='" + q + "'";
                con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Rohan Bose\Desktop\New Folder (19)\bal\App_Data\data.mdf;Integrated Security=True;User Instance=True");
                con.Open();
                sda = new SqlDataAdapter(s, con);
                sda.Fill(ds, "t");
    ...
    static int i9999 = 0;
    protected void Time3_Tick(object sender, EventArgs e)
    {
        string[] s = { "~/img1/1.jpg", "~/img1/2.jpg", "~/img1/3.jpg", "~/img1/4.jpg" };
        if (i9999 < s.Length)
        {
            Imag3.ImageUrl = s[i9999];
            i9999++;
        }
        else
        {
